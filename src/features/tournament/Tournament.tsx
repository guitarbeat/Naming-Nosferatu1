			...
			<div className="relative min-h-screen w-full flex flex-col overflow-hidden font-display text-white selection:bg-primary/30">
				...
				<div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
					<Card className="max-w-2xl w-full text-center p-8" variant="default">
						...
						<p className="text-white/80 mb-6">Your rankings are ready! Start a new tournament or view your results below.</p>
							...
							<div className="flex items-center gap-1.5">
								...
								{handleQuit && (
									<button
										type="button"
										onClick={handleQuit}
										className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/5 text-red-400/70 hover:text-red-400 transition-colors"
			...
			<main className="flex-1 flex flex-col items-center justify-center px-2 sm:px-4 relative py-2 min-h-0">
				...
				<AnimatePresence mode="wait" initial={false}>
					<motion.div
						...
						className="relative flex flex-col sm:flex-row gap-6 sm:gap-8 w-full max-w-5xl mx-auto z-10 items-center justify-center h-full min-h-0"
					>
						{/* Left Card */}
						<div className="flex items-center justify-center sm:flex-1">
							<div className="w-[min(82vw,280px)] sm:w-[min(40vh,300px)] aspect-square">
								<Card
									interactive={true}
									padding="none"
									className={`relative overflow-hidden group cursor-pointer rounded-full h-full w-full animate-float transition-all duration-300 ${
						...
						{/* VS Indicator */}
						<div className="flex items-center justify-center py-1 w-full sm:w-20">
