...
const { dbMocks } = vi.hoisted(() => {
	...
	const whereMock = vi.fn().mockReturnValue({ orderBy: orderByMock, limit: limitMock, groupBy: groupByMock });
	const innerJoinMock = vi.fn().mockReturnValue({ where: whereMock, groupBy: groupByMock });
	// orderBy: orderByMock, limit: limitMock, groupBy: groupByMock });
